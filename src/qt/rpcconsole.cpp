...
/**
 * Split Parlay command line into a list of arguments. Aims to emulate \c bash and friends.
 *
...
void RPCConsole::setClientModel(ClientModel *model)
{
    ...
    if (model && clientModel->getPeerTableModel() && clientModel->getBanTableModel())
    {
        ...
        setPrimenodeCount(model->getPrimenodeCountString());
        connect(model, SIGNAL(strPrimenodesChanged(QString)), this, SLOT(setPrimenodeCount(QString)));
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Parlay RPC console.") + "<br>" +
...
void RPCConsole::setPrimenodeCount(const QString &strPrimenodes)
{
    ui->primenodeCount->setText(strPrimenodes);
}
