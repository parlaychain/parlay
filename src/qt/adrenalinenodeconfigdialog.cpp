...
{
    ui->setupUi(this);
    QString desc = "rpcallowip=127.0.0.1<br>rpcuser=REPLACEME<br>rpcpassword=REPLACEME<br>server=1<br>listen=1<br>port=REPLACEMEWITHYOURPORT<br>primenode=1<br>primenodeaddr=" + nodeAddress + "<br>primenodeprivkey=" + privkey + "<br>";
