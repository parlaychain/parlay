...
QString ClientModel::getPrimenodeCountString() const
{
...
void ClientModel::updateMnTimer()
{
    ...
    if(!lockMain)
        return;
    QString newPrimenodeCountString = getPrimenodeCountString();

    if (cachedPrimenodeCountString != newPrimenodeCountString)
    {
        cachedPrimenodeCountString = newPrimenodeCountString;

        emit strPrimenodesChanged(cachedPrimenodeCountString);
    }
}
