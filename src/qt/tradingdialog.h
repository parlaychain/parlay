...
private slots:
    ...
    QString BuyPAR(QString OrderType, double Quantity, double Rate);
    QString SellPAR(QString OrderType, double Quantity, double Rate);
