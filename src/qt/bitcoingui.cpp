...
{
    resize(900, 520);
    setWindowTitle(tr("parlay") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
#endif
    setObjectName("parlay");
    setStyleSheet("#parlay { background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 1.4, stop: 0 #dedede, stop: 1 #ffffff);  }");
    // Accept D&D of URIs
    setAcceptDrops(true);
    ...
    primenodeManagerPage = new PrimenodeManager(this);
    ...
    centralStackedWidget->addWidget(primenodeManagerPage);
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a parlay address"));
    ...
    primenodeManagerAction = new QAction(tr("&Primenodes"), this);
    primenodeManagerAction->setToolTip(tr("Show Prime Nodes status and configure your nodes."));
    primenodeManagerAction->setCheckable(true);
    tabGroup->addAction(primenodeManagerAction);
    ...
    TradingAction = new QAction(tr("&Bittrex"), this);
    ...
    connect(primenodeManagerAction, SIGNAL(triggered()), this, SLOT(showNormalIfMinimized()));
    connect(primenodeManagerAction, SIGNAL(triggered()), this, SLOT(gotoPrimenodeManagerPage()));
    ...
    aboutAction = new QAction(tr("&About parlay"), this);
    aboutAction->setToolTip(tr("Show information about parlay"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for parlay"));
...
void BitcoinGUI::createToolBars()
{
    ...
    toolbar->setStyleSheet("QToolButton { color: #ffffff; text-align: left; font-family: serif; font-weight: bold; font-size: 16px;  font-variant: normal; border: none; padding-top: 10px; padding-bottom: 10px;}"
                           "QToolButton:hover { background-color: #2c2c2c; text-align: left;  border: none; padding-top: 10px; padding-bottom: 10px; }"
                           "QToolButton:checked { color: #2c2c2c; background-color: #ffffff; text-align: left;  border: none; padding-top: 10px; padding-bottom: 10px; }"
                           "QToolButton:pressed { color: #ffffff; background-color: #2c2c2c; text-align: left;  border: none; padding-top: 10px; padding-bottom: 10px; }"
                           "#tabs { color: #ffffff; background-color: #2c2c2c; text-align: left;  border: none; padding-top: 0px; padding-bottom: 0px; }");
    ...
    toolbar->addAction(primenodeManagerAction);
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("parlay client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("parlay client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to parlay network", "", count));
}
...
void BitcoinGUI::gotoPrimenodeManagerPage()
{
    primenodeManagerAction->setChecked(true);
    centralStackedWidget->setCurrentWidget(primenodeManagerPage);
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid parlay address or malformed URI parameters."));
    }
