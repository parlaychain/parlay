...
extern json_spirit::Value primenode(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value primenodelist(const json_spirit::Array& params, bool fHelp);
