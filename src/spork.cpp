// Copyright (c) 2015 The PAR developers
...
bool IsSporkActive(int nSporkID)
{
    ...
    if(mapSporksActive.count(nSporkID)){
        ...
        if(nSporkID == SPORK_1_PRIMENODE_PAYMENTS_ENFORCEMENT) r = SPORK_1_PRIMENODE_PAYMENTS_ENFORCEMENT_DEFAULT;
        ...
        if(nSporkID == SPORK_7_PRIMENODE_SCANNING) r = SPORK_7_PRIMENODE_SCANNING;
        if(nSporkID == SPORK_8_PRIMENODE_PAYMENT_ENFORCEMENT) r = SPORK_8_PRIMENODE_PAYMENT_ENFORCEMENT_DEFAULT;
        if(nSporkID == SPORK_9_PRIMENODE_BUDGET_ENFORCEMENT) r = SPORK_9_PRIMENODE_BUDGET_ENFORCEMENT_DEFAULT;
        if(nSporkID == SPORK_10_PRIMENODE_PAY_UPDATED_NODES) r = SPORK_10_PRIMENODE_PAY_UPDATED_NODES_DEFAULT;
...
{
    if(strName == "SPORK_1_PRIMENODE_PAYMENTS_ENFORCEMENT") return SPORK_1_PRIMENODE_PAYMENTS_ENFORCEMENT;
    ...
    if(strName == "SPORK_7_PRIMENODE_SCANNING") return SPORK_7_PRIMENODE_SCANNING;
    if(strName == "SPORK_8_PRIMENODE_PAYMENT_ENFORCEMENT") return SPORK_8_PRIMENODE_PAYMENT_ENFORCEMENT;
    if(strName == "SPORK_9_PRIMENODE_BUDGET_ENFORCEMENT") return SPORK_9_PRIMENODE_BUDGET_ENFORCEMENT;
    if(strName == "SPORK_10_PRIMENODE_PAY_UPDATED_NODES") return SPORK_10_PRIMENODE_PAY_UPDATED_NODES;
...
{
    if(id == SPORK_1_PRIMENODE_PAYMENTS_ENFORCEMENT) return "SPORK_1_PRIMENODE_PAYMENTS_ENFORCEMENT";
    ...
    if(id == SPORK_7_PRIMENODE_SCANNING) return "SPORK_7_PRIMENODE_SCANNING";
    if(id == SPORK_8_PRIMENODE_PAYMENT_ENFORCEMENT) return "SPORK_8_PRIMENODE_PAYMENT_ENFORCEMENT";
    if(id == SPORK_9_PRIMENODE_BUDGET_ENFORCEMENT) return "SPORK_9_PRIMENODE_BUDGET_ENFORCEMENT";
    if(id == SPORK_10_PRIMENODE_PAY_UPDATED_NODES) return "SPORK_10_PRIMENODE_PAY_UPDATED_NODES";
