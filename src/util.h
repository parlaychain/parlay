...
extern int nAnonymizeParlayAmount;
extern int nLiquidityProvider;
extern bool fEnableDarksend;
extern int64_t enforcePrimenodePaymentsTime;
extern std::string strPrimeNodeAddr;
extern int nPrimenodeMinProtocol;
...
{
    std::string s = strprintf("Parlay-%s", name);
